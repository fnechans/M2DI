...
namespace preset
{
    ...
    void get_animation_data()
    {
        ...
        animationData["DEFAULT_DOWN"].frequency = base::TICKS_PER_SECOND / 2;
        animationData["DEFAULT_DOWN"].clips = {
            {0, 0, 1, 2},
            {6, 0, 1, 2},
        };
        animationData["DEFAULT_RIGHT"].shiftY = -0.75;
        animationData["DEFAULT_RIGHT"].frequency = base::TICKS_PER_SECOND / 2;
        animationData["DEFAULT_RIGHT"].clips = {
            {0, 2, 1, 2},
            {6, 2, 1, 2},
        };
        animationData["DEFAULT_UP"].shiftY = -0.75;
        animationData["DEFAULT_UP"].frequency = base::TICKS_PER_SECOND / 2;
        animationData["DEFAULT_UP"].clips = {
            {0, 4, 1, 2},
            {6, 4, 1, 2},
        };
        animationData["DEFAULT_LEFT"].shiftY = -0.75;
        animationData["DEFAULT_LEFT"].frequency = base::TICKS_PER_SECOND / 2;
