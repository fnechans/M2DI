...
local button = menu:add_button2('topdown', 0, buttonH, buttonW, buttonH, buttonSpriteW, buttonSpriteH, 0)
...
local button = menu:add_button2("quit", 0, buttonH*5, buttonW, buttonH, buttonSpriteW, buttonSpriteH, 0)
button.image = imageManager:get_image('button')
